...
## Journal Paper
1. Tomoaki Takagi, Keiki Takadama, and Hiroyuki Sato: **A Multi-objective Evolutionary Algorithm Using Weight Vector Arrangement Based on Pareto Front Estimation**, Transaction of the Japanese Society for Evolutionary Computation, Vol. 12, No. 2, pp. 45--60, 2021. DOI (in Japanese).
...
1. Kensuke Kano, Tomoaki Takagi, Shoichiro Tanaka, Keiki Takadama, and Hiroyuki Sato: **Variable Elite Population in Grid-based Multi-objective Evolutionary Optimization**, Proc. of The 3rd ASEAN-UEC Workshop on Informatics and Engineering for SDGs, jointly held with ECTI Workshop on BEC, 2pages, 2021.
